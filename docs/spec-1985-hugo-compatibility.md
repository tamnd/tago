...
Last verified: 2026-06-01 (623 builds, 623 passing).

All 370 officially registered Hugo themes (gohugoio/hugoThemes) plus regression
duplicates were tested. 10 theme repositories could not be cloned (deleted,
moved, or made private by their authors). These themes are excluded from the
test count. One confirmed not-found repo: `4ever9/less`.

The 623 passing builds include all themes that could be cloned from the registry.
...
| vienna |
| vncnt-hugo |
| yourfolio | zzossig/hugo-theme-zzo |
